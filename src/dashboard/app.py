...
if page == "Training Dashboard":
    ...
    if runs.empty:
        ...
        with col2:
            ...
            st.image(
                str(run_dir / "BoxF1_curve.png"), caption="F1 Curve", width="stretch"
            )
        ...
        with col2:
            ...
            st.image(
                str(run_dir / "BoxR_curve.png"), caption="Recall Curve", width="stretch"
            )
...
# ==========================================================
    ...
    def show_image(image_name: str, caption: str) -> None:
    ...
    def show_table(csv_name: str, title: str) -> None:
    ...
    with col1:
        show_table("train_class_distribution.csv", "Train Class Distribution")
    with col2:
        show_table("val_class_distribution.csv", "Validation Class Distribution")
    ...
    with tab1:
        ...
        show_image("train_val_class.png", "Train vs Validation Class Distribution")
        show_image("train_val_weather.png", "Train vs Validation Weather Distribution")
        show_image("train_val_scene.png", "Train vs Validation Scene Distribution")
        show_image(
            "train_val_timeofday.png", "Train vs Validation Time of Day Distribution"
        )

        show_table("train_val_class.csv", "Train vs Validation Class Table")
        show_table("train_val_weather.csv", "Train vs Validation Weather Table")
        show_table("train_val_scene.csv", "Train vs Validation Scene Table")
        show_table("train_val_timeofday.csv", "Train vs Validation Time of Day Table")
    ...
    with tab4:
        ...
        if not quality_train.exists() and not quality_val.exists():
            st.warning(
                ...
                "You can export the `data_quality_report()` results to CSV and display them here."
            )
